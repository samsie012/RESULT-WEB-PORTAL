    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLongTitle">The PIN or admission number you entered is either wrong or does not exist.</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
            <img id="wrong" src="Images/wrong.PNG" alt="">
         <p> <b>ACTION REQUIRED : Please, check your input and try again.</p> 
